...
**Estado:** BOR  
**Fecha:** 2026_09_02  
**Deriva de:** ORI_Pendientes_tecnicos_nucleo_v05_BOR_2026_09_02 y ORI_Decisiones_nucleo_v09_APR_2026_09_02  
...
| PT-007 | Publicar textos institucionales de términos de uso y tratamiento de datos. | Las aceptaciones son requisito, pero los textos y sus versiones aún no están disponibles en el núcleo. | Entregar o aprobar documentos institucionales, identificador, versión y mecanismo de publicación. |
...
|---|---|---|---|
| v06 | 2026_09_02 | BOR | Agrega los textos institucionales como dependencia explícita del consentimiento obligatorio. |
